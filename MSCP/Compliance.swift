...
//
//    func checkCompliance(at rulesToCheck: [String], ruleURLS: [URL], then completion: ([[String:String]]) -> ()) {
...
//                    uncheckedRules.append([rule:yam.check])
//                }
//            }
//        }
//        
//        var checkedRules = [[String:String]]()
//
